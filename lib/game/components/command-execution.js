...
.defines(function() {
    ...
    ig.CommandExecution = ig.Class.extend({
        ...
        isUseWithCommand: function( currentCommand ){
            ...
            return( this.hasActiveCommand && this.hasMouseOverInventory() && currentCommand === 'Use' );
        ...
        removeCurrentCommand: function(){
            ...
            var commandPreview = ig.game.getEntitiesByClass(ig.CommandPreview)[0];
            var walkCommand = ig.game.getEntitiesByClass(ig.CommandWalk)[0];

            commandPreview.setCurrentCommand(walkCommand);
