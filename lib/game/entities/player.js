...
.defines(function () {
    ...
    ig.EntityPlayer = ig.global.EntityPlayer = ig.Player.extend({
         ...
         * @param {string} thirdText Text that will be displayed after the first one (if set)
         */
        speak: function(){
            ...
            for(var i=0; i<arguments.length; i++)
                textbubble.addStep(arguments[i],'player',i);
          /*  textbubble.addStep( text, 'player', 1);
            ...
            if( thirdText ){
               ...
               textbubble.addStep( thirdText, 'player', 3);
